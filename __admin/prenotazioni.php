...
<form id="formgruppir" data-toggle="validator"  role="form" action="<?php echo $URL .'/prenotazioni.php'?>" method="post">
...
<form action="<?php echo $URL .'/prenotazioni.php'?>" method="post">
...
function htmldateslot()
{
	...
	<div class="form-group">
	<label for="servizio" class="control-label"><?php $l="Ateneo / Tipologia utente"; echo l($l); ?></label>
	<div class="input-group">
...
<form id="formgruppir" action="<?php echo $URL .'/prenotazioni.php'?>" method="post">
		...
		foreach($risorse as $ris)
		{
				...
				foreach($ris['elenco_slot_possibili'] as $kslot => $slot)
				{
					...
					else
					{
						...
						printf('<a href="%s/prenotazioni.php?submit=%s&IDR=%s&data=%s&slot=%s&orada=%s" style="color:blue">%s</a>',  $URL, AVANTI, $ris['_key'], $dataitarov, $kslot, $slot['ora'], l("prenota!"));
...
<form id="formateneo" action="<?php echo $URL .'/prenotazioni.php'?>" method="post">

  <div class="form-group">
    <label for="ateneo" class="control-label"><?php $l="Ateneo / Tipologia utente"; echo l($l); ?></label>
    <div class="input-group">
      <span class="input-group-addon">A</span>
...
<form id="formservizi" action="<?php echo $URL .'/prenotazioni.php'?>" method="post">
...
<form data-toggle="validator" role="form" action="<?php echo $URL .'/prenotazioni.php'?>" method="post">
  ...
  <div class="form-group">
    <div class="checkbox">
      <label>
        ...
        <?php $l="Dichiaro di aver preso visione della"; echo l($l); ?> <a href="https://www.MY_SITE.it/it/privacy/informativa_prenotazioni.pdf" target="_blank">informativa sul trattamento dei dati personali</a> *
      </label>
